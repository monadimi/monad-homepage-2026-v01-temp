    ...
    cards: [
      {
        id: 'webpl-card-a',
        title: '웹플 프로젝트',
        subtitle: '기획부터 배포까지 전 과정 실습',
        image: cycleWebplImage,
      },
      {
        id: 'webpl-card-b',
        title: '프론트엔드 스터디',
        subtitle: '컴포넌트 구조와 상태 관리 심화',
        image: cycleWebplImage,
      },
    ],
  },
    ...
    cards: [
      {
        id: 'ebi-card-a',
        title: '브랜딩 워크숍',
        subtitle: '제품 메시지와 사용자 관점 정리',
        image: cycleEbiImage,
      },
      {
        id: 'ebi-card-b',
        title: '문제정의 세션',
        subtitle: '실행 가능한 MVP 범위 설정',
        image: cycleEbiImage,
      },
    ],
  },
    ...
    cards: [
      {
        ...
        title: '도메인 리서치',
        subtitle: '사회 문제 기반 기술 적용 탐색',
        image: cycleLiberationImage,
      },
      {
        id: 'liberation-card-b',
        title: '실험 프로젝트',
        subtitle: '짧은 주기 프로토타입 반복',
        image: cycleLiberationImage,
      },
    ],
  },
    ...
    cards: [
      {
        id: 'decon-card-a',
        title: '문제 분해 세션',
        subtitle: '요구사항과 우선순위 구조화',
        image: cycleDeconImage,
      },
      {
        id: 'decon-card-b',
        title: '아키텍처 리뷰',
        subtitle: '설계 검증과 리스크 분석',
        image: cycleDeconImage,
      },
    ],
  },
